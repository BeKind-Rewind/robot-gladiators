...
var enemyNames = ["Laser", "Blazer", "Michele"];
var enemyHealth = 50;
var enemyAttack = 12;
  ...
  for (var i = 0; i < enemyNames.length; i++) {
    ...
    if (playerHealth > 0) {
      ...
      if (playerHealth > 0 && i < enemyNames.length - 1) {
        ...
        window.alert("You have lost your robot in battle and are shamed! Game Over!");
        break;
      }
    }

    // after loop, either out of health or enemies so run endgame()
  endGame();
}
